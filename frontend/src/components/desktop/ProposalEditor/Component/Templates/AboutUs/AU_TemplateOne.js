  ...
  return (
    ...
    >
      <LineColorComponent
        ...
        classNameOfLineDiv="au_template_one__left__image_container_line"
        ...
        {...props}
      />
      <div className="au_template_one__container">
        <div className="au_template_one__headline_text-container">
          <div className="au_template_one__top">
            <LineColorComponent
              noEditMode={props.noEditMode}
              classNameOfLineDiv="au_template_one__headline_dot"
          ...
          <div className="au_template_one__para_container">
        ...
        <div className="au_template_one__right">
          <ImageComponent
