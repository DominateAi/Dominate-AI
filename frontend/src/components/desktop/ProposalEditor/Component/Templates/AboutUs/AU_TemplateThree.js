...
export class AU_TemplateThree extends Component {
  render() {
    return (
...
export default AU_TemplateThree;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="about_us_template_three"
      className="au_template_three template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="au_template_three__top">
        <div className="au_template_three__top__headline">
          <TextComponent
        ...
        <LineColorComponent
          noEditMode={props.noEditMode}
          classNameOfLineDiv="about_us_template_three__left_title_vertical_line"
          ...
          {...props}
        />
        <div className="au_template_three__top__right">
          <LineColorComponent
            noEditMode={props.noEditMode}
            classNameOfLineDiv="about_us_template_three__left_title_horizontal_line"
      ...
      <div className="au_template_three__bottom">
        <div className="au_template_three__bottom--left">
          <div className="au_template_three__bottom--left--top">
            <TextComponent
        ...
        <div className="au_template_three__bottom--right">
          <ImageComponent
