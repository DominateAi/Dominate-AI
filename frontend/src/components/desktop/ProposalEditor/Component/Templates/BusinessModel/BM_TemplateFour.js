...
export class BM_TemplateFour extends Component {
  render() {
    return (
...
export default BM_TemplateFour;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="business_model_template_four"
      className="business_model_template_four template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="business_model_template_four_headline">
        <TextComponent
      ...
      <div className="business_model_template_four_middle">
        <div className="business_model_template_four_middle_para">
          <TextComponent
      ...
      <div className="business_model_template_four_middle_bottom">
        <ImageComponent
