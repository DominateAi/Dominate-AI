...
export class BM_TemplateThree extends Component {
  render() {
    return (
...
export default BM_TemplateThree;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="business_model_template_three"
      className="business_model_template_three template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <LineColorComponent
        noEditMode={props.noEditMode}
        classNameOfLineDiv="business_model_template_three_top_line"
        ...
        {...props}
      />
      <div className="business_model_template_three_bottom">
        <div className="business_model_template_three_bottom_left">
          <ImageComponent
        ...
        <div className="business_model_template_three_bottom_right">
          <div className="business_model_template_three_bottom_right_headline">
            <TextComponent
          ...
          <div className="business_model_template_three_bottom_right_para">
            <TextComponent
