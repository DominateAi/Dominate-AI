...
export class BM_TemplateTwo extends Component {
  render() {
    return (
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="business_model_template_two"
      className="business_model_template_two template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="business_model_template_two_left">
        <ImageComponent
      ...
      <div className="business_model_template_two_right">
        <div className="business_model_template_two_right_top">
          <div className="business_model_template_two_headline">
            <TextComponent
          ...
          <LineColorComponent
            noEditMode={props.noEditMode}
            classNameOfLineDiv="business_model_template_two_top_line"
        ...
        <div className="business_model_template_two_para">
          <TextComponent
