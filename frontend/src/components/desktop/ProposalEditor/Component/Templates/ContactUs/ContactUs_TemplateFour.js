...
export class ContactUs_TemplateFour extends Component {
  render() {
    return (
...
export default ContactUs_TemplateFour;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="contact_us_template_four"
      className="contact_us_template_four template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="contact_us_template_four_headline">
        <TextComponent
      ...
      <div className="contact_us_template_four_middle">
        <div className="contact_us_template_four_middle_para">
          <TextComponent
      ...
      <div className="contact_us_template_four_middle_bottom">
        <ImageComponent
