...
export class ContactUs_TemplateThree extends Component {
  render() {
    return (
...
export default ContactUs_TemplateThree;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="contact_us_template_three"
      className="contact_us_template_three template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="contact_us_template_three_block">
        <div className="contact_us_template_three_left">
          <ImageComponent
        ...
        <div className="contact_us_template_three_right">
          <div className="contact_us_template_three_headline">
            <TextComponent
          ...
          <div className="contact_us_template_three_para">
            <TextComponent
      ...
      <LineColorComponent
        noEditMode={props.noEditMode}
        classNameOfLineDiv="contact_us_template_three_bottom_line"
