...
export class FA_TemplateThree extends Component {
  render() {
    return (
...
export default FA_TemplateThree;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="financial_analysis_template_three"
      className="financial_analysis_template_three template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <LineColorComponent
        noEditMode={props.noEditMode}
        classNameOfLineDiv="financial_analysis_template_three_top_line"
        ...
        {...props}
      />
      <div className="financial_analysis_template_three_bottom">
        <div className="financial_analysis_template_three_bottom_left">
          <ImageComponent
        ...
        <div className="financial_analysis_template_three_bottom_right">
          <div className="financial_analysis_template_three_bottom_right_headline">
            <TextComponent
          ...
          <div className="financial_analysis_template_three_bottom_right_para">
            <TextComponent
