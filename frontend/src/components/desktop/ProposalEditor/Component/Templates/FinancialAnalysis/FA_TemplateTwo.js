...
export class FA_TemplateTwo extends Component {
  render() {
    return (
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="financial_analysis_template_two"
      className="financial_analysis_template_two template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="financial_analysis_template_two_left">
        <ImageComponent
      ...
      <div className="financial_analysis_template_two_right">
        <div className="financial_analysis_template_two_right_top">
          <div className="financial_analysis_template_two_headline">
            <TextComponent
          ...
          <LineColorComponent
            noEditMode={props.noEditMode}
            classNameOfLineDiv="financial_analysis_template_two_top_line"
        ...
        <div className="financial_analysis_template_two_para">
          <TextComponent
