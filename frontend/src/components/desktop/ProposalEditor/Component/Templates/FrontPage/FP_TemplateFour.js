...
export class FP_TemplateFour extends Component {
  render() {
    return (
...
export default FP_TemplateFour;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="front_page_template_four"
      className="front_page_template_four template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="front_page_template_four__container">
        <div className="front_page_template_four__left">
          <TextComponent
        ...
        <div className="front_page_template_four__right">
          <div className="front_page_template_one__right_logo_area_container ">
            {props.template_data.display_logo ? (
              <CompanyLogo {...props} />
            ) : null}
          </div>
          <div className="front_page_template_four__right--image-container">
            <ImageComponent
