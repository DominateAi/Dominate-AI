...
export class OCapabilities_TemplateFour extends Component {
  render() {
    return (
...
export default OCapabilities_TemplateFour;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="our_capabilities_template_four"
      className="our_capabilities_template_four template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="our_capabilities_template_four__top">
        <div className="our_capabilities_template_four__top__headline">
          <TextComponent
        ...
        <LineColorComponent
          noEditMode={props.noEditMode}
          classNameOfLineDiv="our_capabilities_template_four__top__line"
      ...
      <div className="our_capabilities_template_four__bottom">
        <div className="our_capabilities_template_four__bottom_blocks">
          <div className="our_capabilities_template_four__bottom_blocks_small">
            <div className="our_capabilities_template_four__bottom_blocks__left">
              <IconComponent
            ...
            <div className="our_capabilities_template_four__bottom_blocks__right">
              <div className="our_capabilities_template_four__bottom_blocks__right_headline">
                <TextComponent
              ...
              <div className="our_capabilities_template_four__bottom_blocks__right_para">
                <TextComponent
