...
export class OCapabilities_TemplateOne extends Component {
  render() {
    return (
...
export default OCapabilities_TemplateOne;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="our_capabilities_template_one"
      className="our_capabilities_template_one template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <LineColorComponent
        noEditMode={props.noEditMode}
        classNameOfLineDiv="our_capabilities_template_one__left__line"
        ...
        {...props}
      />
      <div className="our_capabilities_template_one__container">
        <div className="our_capabilities_template_one__top">
          <LineColorComponent
            noEditMode={props.noEditMode}
            classNameOfLineDiv="our_capabilities_template_one__top_black_dot"
            ...
            {...props}
          />
          <div className="our_capabilities_template_one__top_headline">
            <TextComponent
        ...
        <div className="our_capabilities_template_one__bottom">
          <div className="our_capabilities_template_one__bottom_blocks">
            <div className="our_capabilities_template_one_icon_block">
              <IconComponent
            ...
            <div className="our_capabilities_template_one_text_block">
              <TextComponent
