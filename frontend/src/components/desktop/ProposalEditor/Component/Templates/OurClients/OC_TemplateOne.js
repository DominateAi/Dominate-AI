...
export class OC_TemplateOne extends Component {
  render() {
    return (
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="our_clients_template_one"
      className="our_clients_template_one template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <LineColorComponent
        noEditMode={props.noEditMode}
        classNameOfLineDiv="our_clients_template_one__left_line"
        ...
        {...props}
      />
      <div className="our_clients_template_one__right">
        <div className="our_clients_template_one__title">
          <LineColorComponent
            noEditMode={props.noEditMode}
            classNameOfLineDiv="our_clients_template_one__dot"
            ...
            {...props}
          />
          <div className="our_clients_template_one_headline">
            <TextComponent
        ...
        <div className="our_clients_template_one_bottom">
          <div className="our_clients_template_one_bottom_conatiner">
            <div className="our_clients_template_one_bottom_img">
              <ImageComponent
            ...
            <div className="our_clients_template_one_bottom_text">
              <TextComponent
