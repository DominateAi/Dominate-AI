...
export class OC_TemplateTwo extends Component {
  render() {
    return (
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="our_clients_template_two"
      className="our_clients_template_two template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="our_clients_template_two__title">
        <div className="our_clients_template_two_headline">
          <TextComponent
        ...
        <LineColorComponent
          noEditMode={props.noEditMode}
          classNameOfLineDiv="our_clients_template_two__line"
      ...
      <div className="our_clients_template_two_bottom">
        <div className="our_clients_template_two_bottom_conatiner">
          <div className="our_clients_template_two_bottom_img">
            <ImageComponent
          ...
          <div className="our_clients_template_two_bottom_text">
            <TextComponent
        ...
        <div className="our_clients_template_two_bottom_conatiner our_clients_template_two_bottom_conatiner--two">
          <div className="our_clients_template_two_bottom_img ">
            <ImageComponent
        ...
        <div className="our_clients_template_two_bottom_conatiner our_clients_template_two_bottom_conatiner--three">
          <div className="our_clients_template_two_bottom_img our_clients_template_two_bottom_img--three">
            <ImageComponent
