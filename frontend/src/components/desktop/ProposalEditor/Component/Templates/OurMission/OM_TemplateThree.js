...
export class OM_TemplateThree extends Component {
  render() {
    return (
...
export default OM_TemplateThree;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="our_mission_page_template_three"
      className="our_mission_page_template_three template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="our_mission_page_template_three__top--container">
        <LineColorComponent
          noEditMode={props.noEditMode}
          classNameOfLineDiv="our_mission_page_template_three__left_line"
          ...
          {...props}
        />
        <div className="our_mission_page_template_three__title--container">
          <div className="our_mission_page_template_three__headline">
            <TextComponent
          ...
          <LineColorComponent
            noEditMode={props.noEditMode}
            classNameOfLineDiv="our_mission_page_template_three__line"
        ...
        <LineColorComponent
          noEditMode={props.noEditMode}
          classNameOfLineDiv="our_mission_page_template_three__left_line--right"
          classNameString="img_block_line_background"
          backgroundColor={props.template_data.img_block_line_background}
          onTemplateItemChangeWithoutEvent={
            props.onTemplateItemChangeWithoutEvent
      ...
      <div className="our_mission_page_template_three__bottom">
        <div className="our_mission_page_template_three__bottom-left">
          <div className="our_mission_page_template_three__bottom-left--image">
            <ImageComponent
          ...
          <div className="our_mission_page_template_three__bottom-left--text">
            <TextComponent
        ...
        <div className="our_mission_page_template_three__bottom-right">
          <div className="our_mission_page_template_three__bottom-right--title">
            <TextComponent
          ...
          <div className="our_mission_page_template_three__bottom-right--text">
            <TextComponent
