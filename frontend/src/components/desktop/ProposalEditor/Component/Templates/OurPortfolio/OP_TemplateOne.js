...
export class OP_TemplateOne extends Component {
  render() {
    return (
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="our_portfolio_template_one"
      className="our_portfolio_template_one template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <LineColorComponent
        noEditMode={props.noEditMode}
        classNameOfLineDiv="our_portfolio_template_one__left-line"
        ...
        {...props}
      />
      <div className="our_portfolio_template_one--right-section">
        <div className="our_portfolio_template_one--title">
          <LineColorComponent
            noEditMode={props.noEditMode}
            classNameOfLineDiv="our_portfolio_template_one__dot"
            ...
            {...props}
          />
          <div className="our_portfolio_template_one_headline">
            <TextComponent
        ...
        <div className="our_portfolio_template_one_bottom">
          <div className="our_portfolio_template_one_bottom--conatiner">
            <div className="our_portfolio_template_one_bottom--img">
              <ImageComponent
            ...
            <div className="our_portfolio_template_one_bottom--text">
              <TextComponent
