...
export class OP_TemplateThree extends Component {
  render() {
    return (
...
export default OP_TemplateThree;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="our_portfolio_template_three"
      className="our_portfolio_template_three template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="our_portfolio_template_three__top">
        <div className="our_portfolio_template_three__headline">
          <TextComponent
        ...
        <LineColorComponent
          noEditMode={props.noEditMode}
          classNameOfLineDiv="our_portfolio_template_three__right_line"
      ...
      <div className="our_portfolio_template_three__bottom">
        <div className="our_portfolio_template_three__bottom_left">
          <div className="our_portfolio_template_three__bottom_img_container">
            <ImageComponent
          ...
          <div className="our_portfolio_template_three__bottom_text_container">
            <TextComponent
        ...
        <div className="our_portfolio_template_three__bottom_right">
          <div className="our_portfolio_template_three__bottom_img_container">
            <ImageComponent
