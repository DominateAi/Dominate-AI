...
export class OProcessThree extends Component {
  render() {
    return (
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="our_process_page_template_three"
      className="our_process_page_template_three template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="our_process_page_template_three_top">
        ...
        <LineColorComponent
          noEditMode={props.noEditMode}
          classNameOfLineDiv="our_process_page_template_three_horizontal__line"
      ...
      <div className="our_process_page_template_three_bottom">
        <div className="our_process_page_template_three_right">
          <ImageComponent
        ...
        <div className="our_process_page_template_three_left">
          <div className="our_process_page_template_three_left-text">
            <TextComponent
