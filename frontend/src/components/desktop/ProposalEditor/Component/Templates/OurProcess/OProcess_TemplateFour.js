...
export class OProcess_TemplateFour extends Component {
  render() {
    return (
...
export default OProcess_TemplateFour;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="our_process_page_template_four"
      className="our_process_page_template_four template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="our_process_page_template_four_top">
        <div className="our_process_page_template_four_headline">
          <TextComponent
      ...
      <div className="our_process_page_template_four_bottom">
        <div className="our_process_page_template_four_bottom_left">
          <ImageComponent
        ...
        <div className="our_process_page_template_four_bottom_right">
