...
export class OT_TemplateFour extends Component {
  render() {
    return (
...
export default OT_TemplateFour;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="our_team_template_four"
      className="our_team_template_four template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="our_team_template_four_headline">
      ...
      <div className="our_team_template_four_bottom">
        <div className="our_team_template_four_bottom_row_container">
          {/* block one */}
          <div className="our_team_template_four_bottom_block">
            <div className="our_team_template_four_bottom_block_img">
              <ImageComponent
            ...
            <div className="our_team_template_four_bottom_block_headline">
              <TextComponent
            ...
            <div className="our_team_template_four_bottom_block_para">
              <TextComponent
