...
export class Swot_TemplateOne extends Component {
  render() {
    return (
...
export default Swot_TemplateOne;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="swot_template_one"
      className="swot_template_one template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <LineColorComponent
        noEditMode={props.noEditMode}
        classNameOfLineDiv="swot_template_one_left__line"
        ...
        {...props}
      />
      <div className="swot_template_one_right">
        <div className="swot_template_one__top">
          <LineColorComponent
            noEditMode={props.noEditMode}
            classNameOfLineDiv="swot_template_one_top_black_dot"
            ...
            {...props}
          />
          <div className="swot_template_one_top_headline">
            <TextComponent
        ...
        <div className="swot_template_one_bottom">
          {/* block 1 */}
          <div className="swot_template_one_bottom_block">
            <div className="swot_template_one_bottom_block_top">
              <ImageComponent
            ...
            <div className="swot_template_one_bottom_block_bottom">
              <TextComponent
