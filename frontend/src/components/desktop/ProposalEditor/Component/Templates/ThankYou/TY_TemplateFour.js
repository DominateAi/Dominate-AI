...
export class TY_TemplateFour extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
...
export default TY_TemplateFour;
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="thank_you_four"
      className="thank_you_four template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="thank_you_four_img">
        <ImageComponent
      ...
      <div className="thank_you_four_text">
        <div className="thank_you_four_headline">
          <TextComponent
        ...
        <div className="thank_you_four_para">
          <TextComponent
