...
export class TY_TemplateOne extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
...
export const TemplateArea = (props) => {
  ...
  return (
    <div
      id="thank_you_one"
      className="thank_you_one template_main_container_display_area"
      style={{ backgroundColor: backgroundColor }}
    >
      <LineColorComponent
        noEditMode={props.noEditMode}
        classNameOfLineDiv="thank_you_one_line"
      ...
      <div className="thank_you_one__left">
        <TextComponent
      ...
      <div className="thank_you_one__right">
        <ImageComponent
