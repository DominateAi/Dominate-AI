...
import { createNote } from "./../../../store/actions/accountsAction";
import { useDispatch, useSelector } from "react-redux";
import isEmpty from "../../../store/validations/is-empty";

const totalFormSlides = 1;
function AddNotes({ addTaskButtonClassName, addTaskButtonText }) {
  ...
  const handleSubmitFunctionMain = (e) => {
    ...
    dispatch(createNote(newTask, callbackAddTask));
  };
  ...
  const renderAddTaskForm = () => {
    ...
    return (
      <div className="add-lead-modal-container container-fluid lead_page_component pr-0">
        <h1 className="font-30-bold mb-61">New Note</h1>
