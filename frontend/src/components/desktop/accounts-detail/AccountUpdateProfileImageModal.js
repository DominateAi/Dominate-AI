...
class AccountUpdateProfileImageModal extends React.Component {
  state = {
    open: false,
    fileName: "",
  ...
  render() {
    ...
    return (
      <>
        {/* modal link */}
        <div
          className="account-profile-img-colm__edit"
          onClick={this.onOpenModal}
        >
          <img
            src={require("../../../assets/img/accounts/account-edit-icon.svg")}
            alt="edit"
          />
        </div>
        ...
        >
          <div className="ac-files-modal-container">
            ...
            {/* content title*/}
            <h3 className="font-21-bold mb-48">Update account image</h3>
