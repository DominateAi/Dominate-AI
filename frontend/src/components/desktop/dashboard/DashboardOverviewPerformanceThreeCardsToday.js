...
const first = (
  <div className="performance-score-block">
    <h1 className="font-40-extraBold">75</h1>
...
const second = (
  <div className="performance-score-block">
    <h1 className="font-32-extraBold">50</h1>
    <p className="font-12-light">Leads Closed</p>
    {/* img and badge */}
    <div className="img-badge-outer">
...
const third = (
  <div className="performance-score-block">
    <h1 className="font-32-extraBold">35</h1>
    <p className="font-12-light">Leads Closed</p>
    {/* img and badge */}
    <div className="img-badge-outer">
      <div className="img-badge-text-outer">
...
const DashboardOverviewPerformanceThreeCardsToday = ({
  firstUser,
  secondUser,
  thirdUser,
  leaderBoardCurrent,
  ...
  if (leaderBoardCurrent) {
    totalMembers = leaderBoardCurrent.length;
  }
      ...
      {arr3.map((data, index) => (
        <div key={index} className="performance-score-block">
          ...
          <div className="img-badge-outer">
            ...
            <img
              src={`${data.user.profileImage}&token=${dataToken.token}`}
              alt="person"
              className="performace-scoreboard-img"
            />
          </div>
...
export default DashboardOverviewPerformanceThreeCardsToday;
