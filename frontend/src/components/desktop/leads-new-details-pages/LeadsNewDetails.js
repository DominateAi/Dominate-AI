...
import { getLeadById } from "./../../../store/actions/leadAction";
...
import LeadsNewDetailsProfile from "./LeadsNewDetailsProfile";
import activeTabCircleImg from "../../../../src/assets/img/leads-new/leads-new-inner-page-active-tab-circle.svg";
import LeadsNewDetailsActivityLog from "./LeadsNewDetailsActivityLog";
import LeadsNewDetailsProfileForm from "./LeadsNewDetailsProfileForm";
import LeadsNewDetailsProfileFormDisplay from "./LeadsNewDetailsProfileFormDisplay";
...
import LeadsNewNotes from "./LeadsNewNotes";
...
function LeadsNewDetails() {
  ...
  useEffect(() => {
    ...
    //   payload: this.props.location.state.detail
    // });
  }, []);
    ...
    <>
      ...
      <div className="cmd-centre-block cmd-centre-block--leadsNew cmd-centre-block--leadsNewDetailsPage">
        {/* <div className="row mx-0 align-items-center account-details-new-title-block">
          ...
          <h2 className="font-24-medium new-leads-page-title">Lead</h2>
        </div> */}
        <Tabs defaultTab="one">
          <TabList>
            <Tab tabFor="one">
...
export default LeadsNewDetails;
