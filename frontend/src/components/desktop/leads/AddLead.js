...
function AddLead({
  ...
  ==================================*/
  const onClickStatusButton = (status) => (e) => {
    e.preventDefault();
    console.log(status);
    setValues({
      ...values,
      leadStatusNew: status,
    });
  };
    ...
    const setStatusAndLevel = (
      <div className="mb-30">
        ...
        <div className="set_level_and_status_of_lead set_level_and_status_of_lead--status">
          <p>Status</p>
          <button
            onClick={onClickStatusButton("New Lead")}
            className={
              values.leadStatusNew === "New Lead"
                ? "select-lead-followup-by-btn select-lead-followup-by-btn--active"
                : "select-lead-followup-by-btn"
            }
          >
          ...
          <button
            ...
            className={
              values.leadStatusNew === "On Hold Lead"
                ? "select-lead-followup-by-btn select-lead-followup-by-btn--active"
                : "select-lead-followup-by-btn"
            }
          >
