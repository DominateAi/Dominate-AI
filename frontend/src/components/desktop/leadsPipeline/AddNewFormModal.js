...
class AddNewFormModal extends React.Component {
  ...
  updateinitialStatusDropDownOption = (index, newStagesArray) => {
    console.log(index);
    this.setState({
      selectedStatusOptionDropdown: newStagesArray[index],
      leadStatus: newStagesArray[index].value,
    });
  };
  ...
  onOpenModal = () => {
    ...
    const { allPipelineStages } = this.props;
    ...
    if (!isEmpty(allPipelineStages)) {
      ...
      this.setState({
        selectStatusDropdownOptions: newStagesArray,
      });
  ...
  handleSubmitFunctionMain = () => {
    ...
    if (isValid) {
      ...
      this.props.addpipelineLeadsAction(
        {
          ...
          phoneCode: leadsPhoneCountryNumber,
    ...
    return (
      ...
      >
        ...
        <h1 className="font-30-bold mb-61">
          Add New{" "}
          {!isEmpty(this.state.selectStatusDropdownOptions) &&
            this.state.selectStatusDropdownOptions[
              this.props.initialStatusDropDownOption
            ].value}{" "}
        </h1>
        <div
      ...
      <div className="mb-30">
        ...
        <div className="set_level_and_status_of_lead">
          ...
          <Select
            ...
            isSearchable={false}
            options={this.state.selectStatusDropdownOptions}
...
const mapStateToProps = (state) => ({
  ...
  allPipelineStages: state.leadsPipeline.allPipelineStages,
});
