...
class OverviewDemoNewDealPipelines2 extends Component {
  constructor() {
    super();
    this.state = {
      open: true,
      ...
      <Fragment>
        ...
        <Modal
          ...
          classNames={{
            ...
            modal:
              "customModal customModal--walkthrough customModal--walkthrough-deal-pipelines-2",
...
export default connect(mapStateToProps, {})(OverviewDemoNewDealPipelines2);
